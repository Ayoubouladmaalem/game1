...
function preload() {
    ...
    // this.laod.audio('gameover','assets/game-over.wav');
...
function create() {
    ...
    // Increment incorrect clicks and check game over condition
    function checkGameOver() {
        ...
        if (incorrectClicks >= maxIncorrectClicks) {
            ...
            swal.fire({
                title: "Game Over!",
                text: "You've reached the maximum incorrect clicks.",
                icon: "error",
                showConfirmButton: false,
                allowOutsideClick: false,
                allowEscapeKey: false
            });
            // Optionally, you might want to reset the game or take other actions
        }
    }
