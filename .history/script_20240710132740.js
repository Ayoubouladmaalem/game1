...
function create ()
{
    ...
    var circle1 = this.add.image(630, 290, 'circle');
    var circle2 = this.add.image(480, 290, 'circle');
    var circle3 = this.add.image(330, 290, 'circle');
    var circle4 = this.add.image(180, 290, 'circle');
