...
function create() {
    ...
    lettersOnCircles.forEach((letterText, index) => {
        ...
        letterText.on('pointerdown', function() {
            ...
            //   var boardText = this.add.text(letterImage.x, letterImage.y, getDisplayWordWithHiddenFirstLetter(currentIncompleteWord), textStyle).setOrigin(0.5);
            var boardText = this.add.text(boardImage.x, boardImage.y,'أحسنت' , woodTextStyle).setOrigin(0.5);

              var boardImage =  animateImage.call(this, 'board', 400, 500);
