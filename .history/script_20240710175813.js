...
var question =["اختر الحرف المناسب للكلمة الناقصة"]
function preload() {
...
function create() {
    ...
    var question = this.add.image(400, 60, 'wood');
    ...
    // Display the question text on top of the question image
    var questionText = this.add.text(questionImage.x, questionImage.y, "اختر الحرف المناسب للكلمة الناقصة", textStyle).setOrigin(0.5);
