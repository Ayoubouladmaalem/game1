...
WebFont.load({
    ...
    active: () => {
        // Initialize Phaser game after the font is loaded
        var config = {
            type: Phaser.AUTO,
            width: 800,
            height: 600,
...
function create() {
            ...
            var woodTextStyle = { font: "32px ''", fill: "#FDCD2B", align: "center" };
            ...
            var textStyle = { font: "32px 'Marhey'", fill: "#000000", align: "center" };
...
function animateImage(imageKey, targetX, targetY, callback) {
...
letterText.on('pointerdown', function() {
    var letter = letterText.text;
    if (letter === beginningLetter) {
        animateImage.call(this, 'happy', letterText.x, letterText.y, function() {
            currentIncompleteWord = beginningLetter + currentIncompleteWord.substring(1); // Replace '_' with the correct letter
            wordText.setText(getDisplayWord(currentIncompleteWord));
            // Add any text reading logic here
        });
    } else {
        animateImage.call(this, 'sad', letterText.x, letterText.y);
    }
