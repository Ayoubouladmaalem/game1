...
function create() {
    // WebFont.load({
    //     custom: {
    //         families: ['ts_split_arabic'],
    //         urls: ['path/to/your/font/stylesheet.css'] // Replace with the actual path to your font stylesheet
    //     },
    //     active: () => {
    //         // The font has been loaded, create the text
            var woodImage = this.add.image(400, 60, 'wood');
            var woodTextStyle = { font: "32px Droid Arabic Kufi", fill: "#FDCD2B", align: "center" };
    ...
    // var woodImage = this.add.image(400, 60, 'wood');
    // var woodTextStyle = { font: "32px ts_split_arabic", fill: "#FDCD2B", align: "center" };
    // var woodText = this.add.text(woodImage.x, woodImage.y,"اختر الحرف المناسب لبداية الكلمة", woodTextStyle).setOrigin(0.5);
