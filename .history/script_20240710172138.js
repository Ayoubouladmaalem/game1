    ...
    lettersOnCircles.forEach((letterText, index) => {
        ...
        letterText.on('pointerdown', function() {
            ...
            if (letter === beginningLetter) {
                ...
                // Replace the circle with 'spot.png'
                var circle = letterText.parentContainer;
                circle.setTexture('spot');
                letterText.destroy(); // Remove the letter text after correct selection
            } else {
