...
function create ()
{
    ...
    var circle1 = this.add.image(650, 250, 'circle');
    var circle2 = this.add.image(500, 250, 'circle');
    var circle3 = this.add.image(350, 250, 'circle');
    var circle4 = this.add.image(200, 250, 'circle');
