...
function create() {
    ...
    var woodTextStyle = { font: "32px Arial", fill: "#000000", align: "center" };
    var woodText = this.add.text(woodImage.x, woodImage.y,"اختر الحرف المناسب لإكمال بداية الكلمة النافصة", woodTextStyle).setOrigin(0.5);
