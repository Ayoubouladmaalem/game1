...
function updateCircles() {
    ...
    if (numCircles === 1) {
        var circle = this.add.image(400, 300, 'circle');
        this.circles.push(circle);

        var letterText = this.add.text(circle.x, circle.y, getRandomLetter(letters), { font: "32px Arial", fill: "#000000", align: "center" }).setOrigin(0.5);
