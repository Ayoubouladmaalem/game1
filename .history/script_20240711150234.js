...
function create() {
    ...
    var boardImage = this.add.image(400, 500, 'board'); // Adjusted position for boardImage

    var boardTextStyle = { fontFamily: 'Marhey', fontSize: '28px', fill: '#FDCD2B', align: 'center' };
    var boardText = this.add.text(boardImage.x, boardImage.y, "أحسنت", boardTextStyle).setOrigin(0.5); // Adjusted position for boardText
