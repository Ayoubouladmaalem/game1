...
function create() {
    ...
    // var wordInfo = getDisplayWordWithHiddenFirstLetter(currentIncompleteWord);
    // var wordText = this.add.text(letterImage.x, letterImage.y, wordInfo.text, wordInfo.style).setOrigin(0.5);
...
function getDisplayWordWithHiddenFirstLetter(word) {
    ...
    return { text: displayWord, style: { font: "32px Arial", fill: "#000000", align: "center" } };
}
