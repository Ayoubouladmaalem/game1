...
function update() {
    ...
    if (currentIncompleteWord === beginningLetter + getDisplayWordWithHiddenFirstLetter(currentIncompleteWord).substring(1)) {
        // Replace circle2 with 'spot' image
        var spot = this.add.image(600, 220, 'spot');
        // Destroy circle2
        this.children.remove(circle2); // Remove circle2 from the display list
    }
}
