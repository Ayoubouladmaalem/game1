...
var selectedLetter = ["أ", "ب", "ت", "ث", "ج", "ح", "خ", "د", "ذ", "ر", "ز", "س", "ش", "ص", "ض", "ط", "ظ", "ع", "غ", "ف", "ق", "ك", "ل", "م", "ن", "هـ", "و", "ي"];
...
function create() {
    ...
    letterInput.value = selectedLetter; // Set initial value
// Button to update the circles
    var updateButton = this.add.text(650, 480, 'تحديث الحروف', { fontFamily: 'Arial', fontSize: '24px', fill: '#ffffff' })
    .setInteractive()
    .on('pointerdown', updateGameElements);
...
function updateGameElements() {
    ...
    selectedLetter = document.getElementById("letterInput").value;
