...
function create() {
    ...
    var wordText = this.add.text(380, 530, currentIncompleteWord, textStyle);
        ...
        letterText.on('pointerdown', function() {
            ...
            if (isCorrectLetter(letter)) {
                ...
                if (currentIncompleteWord === incompleteWord) {
                    ...
                    console.log("Word completed:", currentIncompleteWord);
                }
            } else {
...
function isCorrectLetter(letter) {
    // Check if the letter is one of the letters in the incomplete word and hasn't been used already
