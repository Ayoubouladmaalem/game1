...
function create ()
{
    ...
    this.add.text(circle1.x, circle1.y, "A", textStyle).setOrigin(0.5);
    this.add.text(circle2.x, circle2.y, "B", textStyle).setOrigin(0.5);
    this.add.text(circle3.x, circle3.y, "C", textStyle).setOrigin(0.5);
}
