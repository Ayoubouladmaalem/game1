...
function create() {
    ...
    var woodTextInput = document.getElementById("boardTextInput").value;  // Get the initial text from the input field
...
function updateGameElements() {
    ...
    var woodTextInput = document.getElementById("boardTextInput").value;
