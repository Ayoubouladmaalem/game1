...
function create() {
    ...
    this.player = this.add.sprite(this.sys.game.config.width / 2, this.sys.game.config.height - 50, 'player').setScale(0.5);
    this.input.on('pointermove', (pointer) => {
        this.player.x += (pointer.x - this.player.x) * 0.1;
        this.player.y += (pointer.y - this.player.y) * 0.1;
    });
    ...
    //   this.input.setDefaultCursor('url(assets/ananas.png), pointer');
}
